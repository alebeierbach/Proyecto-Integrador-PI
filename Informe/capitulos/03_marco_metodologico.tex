...
\section{Prototipos} \vspace{-0.8cm}
...
\section{Diseños de piezas en 3D} \vspace{-0.8cm}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[height=10cm, width=\textwidth, keepaspectratio]{Imagenes/}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[height=10cm, width=\textwidth, keepaspectratio]{Imagenes/}
    \end{minipage}
    \caption{Soporte para DHT22.}
\end{figure}

\section{Selección de componentes} \vspace{-0.8cm}

\subsection{Sustrato} \vspace{-0.8cm}
...
\subsection{Sensores} \vspace{-0.8cm}
